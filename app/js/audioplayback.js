function AudioPlayback()
{
    ...
    this.audioInputChannels = 2;
    this.audioOutputChannels = 2;
    this.sampleRate = 0;
    this.audioContext = new AudioContext();

    // The JavaScriptNode is used to modifiy the output buffer    
    this.javaScriptNode = this.audioContext.createScriptProcessor(this.audioBufferSize, this.audioInputChannels, this.audioOutputChannels);
